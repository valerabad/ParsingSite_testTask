    ...
    static public class HelperPageParsingClass
    {
        public static List<Shoes> ParseSitePage(string url)
        {
            ...
            HtmlNodeCollection titleNodes = document.DocumentNode.SelectNodes
                (".//h3[@class='content-product__name-heading']/a");
            ...
            try
            {
                //div[contains(concat(" ", normalize-space(@class), " "), " product-price ")]
                //div[contains(@class, "product-price")]
                HtmlNodeCollection prices = document.DocumentNode.SelectNodes
                   (".//div[@class='content-product__stock']//div[@class='product-price']//span[@class='wc-price wc-price-on-sale wc-price-variable']//span[@class='wc-price-from']/span");
                   //"span[@class='wc-price-number']");
                int j = 0;
